...
![Lakehouse Federation](/images/databricks-lakehouse-federation-guide/lakehouse-federation-072224.png)
...
![AS-IS: バッチ同期による連携](/images/databricks-lakehouse-federation-guide/before_arch.png)
...
![TO-BE: Federation導入後のアーキテクチャ](/images/databricks-lakehouse-federation-guide/after_arch.png)
...
- **Serverless**: PrivateLink (NCC) 経由で接続
- **Classic**: VPC Peering 経由で接続

Serverlessの場合、Databricksが管理するVPCからPrivateLink経由でAuroraに接続します。

![Serverless ネットワーク構成](/images/databricks-lakehouse-federation-guide/serverless_network.png)
...
![テーブル選択フロー](/images/databricks-lakehouse-federation-guide/table_select_flow.png)
